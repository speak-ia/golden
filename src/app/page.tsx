  ...
  return (
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0d1b2a]/90 via-[#0a0e17]/85 to-[#061018]" />
      ...
      {/* Galerie */}
      <FadeInSection>
      <section className="py-16 md:py-24 bg-[#0a0e17]" id="galerie">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
            Notre galerie
          </h2>
          <p className="text-gray-500 text-center mb-12 max-w-2xl mx-auto">
            Découvrez nos interventions, nos équipes et nos installations en images.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {GALLERY_IMAGES.map((src, i) => (
              <div
                key={src}
                className="relative aspect-square rounded-xl overflow-hidden bg-[#0d1b2a] border border-[#c9a227]/20 group"
              >
                <Image
                  src={src}
                  alt={`Golden Sécurité - photo ${i + 1}`}
                  fill
